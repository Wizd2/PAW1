...
if (isset($_GET['action']) && $_GET['action'] === 'remind') {
    ...
    if (!empty($_POST['login']) && !empty($_POST['email'])) {
        echo '<p>Administrator skontaktuje sie z toba.</p>';
    } else {
...
. '<b>Błąd:</b> nieprawidłowy login lub hasło.</div>';
 ...
 <details style="margin-top:12px;">
   <summary class="btn" style="display:inline-block; list-style:none; cursor:pointer;">Przypomnij hasło</summary>
   <div style="margin-top:12px;">
     <p style="margin:0 0 10px 0;">Podaj login i e-mail. Administrator skontaktuje sie z toba.</p>
     <form method="post" action="admin.php?action=remind">
       <div class="formGrid">
         <div>
           <label for="r_login"><b>Login</b></label><br />
           <input class="input" id="r_login" name="login" type="text" required />
         </div>
         <div>
           <label for="r_email"><b>E-mail</b></label><br />
           <input class="input" id="r_email" name="email" type="email" required />
         </div>
       </div>
       <div style="margin-top:12px;">
