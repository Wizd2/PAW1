...
// Lab12: koszyk dziala na sesji, wiec musimy startowac sesje na stronie
...
// Lab11: produkty (lista produktow + VAT)
include_once('products.php');
// Lab12: koszyk (SESSION)
...
// Dla kontaktu robimy osobna obsluge (nie z bazy), bo tu sa akcje POST
            if ($idp === 'contact') {
              ...
              // Lab11: produkty z bazy (zamiast "statycznych" kart w tresci strony)
              echo PokazProduktySklepu();
            } elseif ($idp === 'cart') {
              // Lab12: koszyk oparty o sesje
              echo PokazKoszyk();
            } else {
      ...
      <tr>
        <td class="footerCell">
          <div class="footerFlex">
            <small>© ClickClick — v2.2 (Lab12) | <span id="datetime"></span></small>
